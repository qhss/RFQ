...
var vue = new Vue({
	...
	methods:{
		...
		create:function(){
			...
			var data={
				"arroundType":that.obj.arroundType,
				"arroundname":that.obj.arroundname,
				"arrounddistance":that.obj.arrounddistance
			};
