...
public class JsonUtils {
	 ...
	 */
	public static <T> T deserialize(String json, Class<T> type) throws JsonParseException, IOException {
	 ...
	 * @throws IOException
	 */
	public static <T> T deserialize(String json, TypeReference<?> type) throws JsonParseException, IOException {
		T t = mapper.readValue(json, type);
		return t;
	}
